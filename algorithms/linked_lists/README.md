...
Most of the operations presented in this section will be performed based on the [helper.py](/algorithms/linked_lists/helper.py) file, and the objects defined there.
